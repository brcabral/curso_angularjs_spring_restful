...
public class FileDownloadController {
	...
	public void downloadPdfPedido(HttpServletRequest request, HttpServletResponse response,
		...
		ArrayList<ItemPedido> itemPedidos = (ArrayList<ItemPedido>) itemPedidoController.lista("pedido.id",
				Long.parseLong(codigoPedido));
		...
		@SuppressWarnings("rawtypes")
		String filePath = reportUtil.geraRelatorio(dados, new HashMap(), "rel_pedido", "rel_pedido", context);
